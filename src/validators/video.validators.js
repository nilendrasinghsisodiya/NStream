...
export const validateGetVideoById = [
  query("videoId").exists().withMessage("videoId is required").isMongoId().withMessage("Invalid videoId"),
  (req, res, next) => {
    const errors = validationResult(req);
