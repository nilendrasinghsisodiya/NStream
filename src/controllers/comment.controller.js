...
const deleteComment = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, deleteRes, 'comment deleted successfully'));
});
...
const getReplies = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, replies, 'commnets fetched successfully'));
});
...
export { getVideoComments, addComment, updateComment, deleteComment, getReplies, addReply };
